...
BOT_NAME_FA = os.getenv("BOT_NAME_FA", "باشگاه مشتریان سبدگردان سورنا")
...
async def handle_ai_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Create a system prompt in Persian for better responses
        system_prompt = f"""You are a helpful customer service assistant for {BOT_NAME_FA}. 
        Respond in Persian (Farsi) language. Be friendly, helpful, and professional. 
        You are Sourena asset management company financial assistant.
        Only answer questions related to investment funds, asset management, portfolio strategies, financial markets, and financial services.
        Give clear, practical, and professional explanations.
        If I ask something outside of finance and investments, politely remind me that your role is limited to the financial world.
        Keep responses concise but informative."""
        
        logging.info(f"Sending message to AI: {user_message}")
